...
var openFB = (function () {
    ...
    */
    ...
    function login(callback, options) {
            //console.log('options', options.$scope);
        var loginWindow,
            startTime,
            scope = '',
        ...
        console.log('optiones', options.$scope);
        //login withouth save into cache (emulator and devices)
        ...
        //login saving login in cache (emulator and devices)
        loginWindow = window.open(loginURL + '?client_id=' + fbAppId + '&redirect_uri=' + redirectURL +
            '&response_type=token&scope=' + options.$scope, '_blank', 'location=no,cache=yes');
    ...
    function api(obj) {
        ...
        //console.log('token: ',tokenStore.fbAccessToken)
        //url = 'https://graph.facebook.com/v2.6' + obj.path + '?fields=id,invitable_friends&access_token=' + params['access_token'];
        //url = 'https://graph.facebook.com/v2.5' + obj.path + '?&access_token=' + params['access_token'];
        url = 'https://graph.facebook.com/v2.6' + obj.path + '?' + toQueryString(params);
